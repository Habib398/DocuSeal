...
<!-- Plantillas utilitarias locales para evitar dependencias de red -->
<xsl:template name="Requerido">
	<xsl:param name="valor"/>
	<xsl:text>|</xsl:text>
	<xsl:value-of select="normalize-space($valor)"/>
	<!-- No agregamos separador final aquí; el cierre || lo hace el template raíz -->
	</xsl:template>
<xsl:template name="Opcional">
	<xsl:param name="valor"/>
	<!-- Para opcionales, se conserva el separador aunque el valor esté vacío -->
	<xsl:text>|</xsl:text>
	<xsl:value-of select="normalize-space($valor)"/>
</xsl:template>
