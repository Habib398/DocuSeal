...
class DBTestInserter:
    # Clase para insertar valores de prueba en la base de datos. (Hecho por Copilot)
    def __init__(self):
        self.db = DBManager()

    def insertar_valores_prueba(self):
        # Valores de prueba
        usuarioPAC = "AAA010101AAA"
        contrasenaPAC = "PWD"
...
if __name__ == "__main__":
    # Crear la tabla certificados_pac si no existe
    db_path = os.path.join(os.path.dirname(__file__), '..', 'certificados_pac.db')
    ...
    cursor.execute('''
        CREATE TABLE IF NOT EXISTS certificados_pac (
            ...
            noCertificado TEXT UNIQUE NOT NULL,
            Certificado TEXT NOT NULL
        )
    ''')
    conn.commit()
    conn.close()
    print("Tabla 'certificados_pac' verificada/creada correctamente.")

    tester = DBTestInserter()
    tester.insertar_valores_prueba()
